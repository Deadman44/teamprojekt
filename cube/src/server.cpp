...
/*
Ab hier folgt eine modifizerte Fassung für den SSL Connect vom Spielserver zum Lizenserver
dort wird überprüft, ob ein neu verbundener CLient ein gültiges Ticket besitzt..
...
int check_client_license_from_server(std::string cTicket, int clientNr)
{
  try
  {
	...
	{
		std::cout << " CLient hat kein gültiges Ticket! ";
		disconnect_client(clientNr,"kein gültiges Ticket");
	}
  }
